...
export class StorageSeccion3Service {
 ...
 async subirImagen(nombre: string, imagen: any){
   try{
     let referenciaImagen = ref(this.storage,'seccion3/'+ nombre);// Guardamos la ruta donde se va a subir la imagen dentro del storage, dentro referenciaImagen
